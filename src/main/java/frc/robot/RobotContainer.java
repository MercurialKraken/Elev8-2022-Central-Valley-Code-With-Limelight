...
import frc.robot.commands.teleop.climber.pg.inner.InnerPGClimberMoveCommand;
...
import frc.robot.commands.teleop.climber.pg.outer.OuterPGClimberMoveCommand;
...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    this.outerClimberSubsystem.setDefaultCommand(
        new OuterClimberCommand(this.outerClimberSubsystem,
            () -> getThresholledAxis(RobotContainer.joyC, OIConstants.OIJoyC.outerClimber_Axis_Three, 0.2)));
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(RobotContainer.joyC, 9)
        .toggleWhenActive(new IntakeCommand(this.intakeSubsystem, this.servoFeederSubsystem));
    new JoystickButton(RobotContainer.joyD, 9)
        .toggleWhenActive(new ReverseCommand(this.intakeSubsystem, this.feederSubsystem));
    ...
    new JoystickButton(RobotContainer.joyD, 8)
        .toggleWhenActive(new ServoFeederCommand(this.servoFeederSubsystem));
    ...
    new JoystickButton(RobotContainer.joyD, 6)
        .toggleWhenActive(new ShooterCommand(this.shooterSubsystem, 2800)); //2750
    ...
    new JoystickButton(RobotContainer.joyD, 10)
        .whenPressed(
          new LimeDance(feederSubsystem, driveSubsystem));
    ...
    new JoystickButton(RobotContainer.joyC, 2)
    ...
    new JoystickButton(RobotContainer.joyC, 6)
        .whenHeld(new OuterPGClimberMoveCommand(this.outerPGSubsystem, 0.8));

    new JoystickButton(RobotContainer.joyC, 8)
        .whenHeld(new OuterPGClimberMoveCommand(this.outerPGSubsystem, -0.99));

    new JoystickButton(RobotContainer.joyC, 5)
        .whenHeld(new InnerPGClimberMoveCommand(this.innerPGSubsystem, 0.8));
  ...
  public Command getAutonomousCommand() {
    ...
    //return new LimelightAlignCommand(driveSubsystem);
    return new AutonomousRoutineCommand(shooterSubsystem, feederSubsystem, driveSubsystem, intakeSubsystem, intakeStarterSubsystem, servoFeederSubsystem);
  }
